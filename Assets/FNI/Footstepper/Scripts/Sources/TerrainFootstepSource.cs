...
namespace GamingIsLove.Footsteps
{
	...
	public class TerrainFootstepSource : FootstepSource
	{
		...
		public virtual Texture GetTextureAt(Vector3 position)
		{
			//FuncTest.Instance.SetLogUI("[TerrianFootstepSource/GetTexture]");
			...
			//FuncTest.Instance.SetLogUI($"{terrain.terrainData.terrainLayers[index].diffuseTexture.name}");
